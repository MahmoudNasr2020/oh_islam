...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('date', $videos->date ,['class'=>'form-control float-right datepicker','placeholder'=>trans('admin.date'),'readonly'=>'readonly']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('url', $videos->url ,['class'=>'form-control','placeholder'=>trans('admin.url')]) !!}
    </div>
</div>
