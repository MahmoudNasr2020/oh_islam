...
class AzkarsDataTable extends DataTable
{
     ...
     * Auto Ajax Method By Baboon Script [it v 1.6.33]
     * @return \Illuminate\Http\JsonResponse
     */
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.azkars.buttons.actions')
   		...
   		->addColumn('created_at', '{{ date("Y-m-d H:i:s",strtotime($created_at)) }}')
            ...
            ->rawColumns(['category','checkbox','actions',]);
    }

	public function query()
    {
        return Azkar::query()->select("azkars.*");
    	...
    	/**
	     * Get columns.
	     * Auto getColumns Method By Baboon Script [it v 1.6.33]
	     * @return array
	     */
