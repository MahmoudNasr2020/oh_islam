...
Route::group(['prefix' => app('admin'), 'middleware' => 'Lang'], function () {
	...
	Route::group(['middleware' => 'admin:admin'], function () {
		...
		Route::resource('azkars','Admin\Azkars'); 
		Route::post('azkars/multi_delete','Admin\Azkars@multi_delete'); 
		Route::resource('werds','Admin\Werds'); 
		Route::post('werds/multi_delete','Admin\Werds@multi_delete'); 
